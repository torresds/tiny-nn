...
int main() {
  ...
  tf::test::run_test("Softmax sanity", test_softmax_ce_sanity);
  tf::test::run_test("Softmax stability", test_softmax_ce_stability);
  tf::test::run_test("Softmax grad check", test_softmax_ce_grad_check);
